...
"""
1) Consulter la documentation sur le dessin pygame à l’adresse suivante :https://www.pygame.org/docs/ref/draw.html
2) Remplacer le rectangle de l’exercice précédent par un disque.
3) Ajouter au disque une bordure.
"""